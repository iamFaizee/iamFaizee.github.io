    ...
    return (
        <Box sx={{ width: "80%", margin: "10% auto", padding: "0% 10px" }}>
            ...
            <Box className='contact-logo' sx={{ marginTop: "2%", display: "flex", justifyContent: "center", alignContent: "start", alignItems: "center", gap: "15px", flexDirection: "column" }}>
                <a className='socialLogo' id="contact-github" target="_blank" rel="noopener noreferrer" href={details.githubLink} style={{ textDecoration: "none", color: "#00FF41", fontSize: "1.7rem" }}><i className="fa-brands fa-github"></i>   iamFaizee</a>
                <a className='socialLogo' id="contact-linkedin" target="_blank" rel="noopener noreferrer" href={details.linkedInLink} style={{ textDecoration: "none", color: "#00FF41", fontSize: "1.7rem" }}><i className="fa-brands fa-linkedin"></i>   Faizan Khan</a>
                <a className='socialLogo' id="contact-phone" target="_blank" rel="noopener noreferrer" href={`tel:+91${details.phone}`} style={{ textDecoration: "none", color: "#00FF41", fontSize: "1.5rem" }}><i class="fa-solid fa-phone"></i>   +91 9711481169</a>
                <a className='socialLogo' id="contact-email" target="_blank" rel="noopener noreferrer" href={`mailto:${details.mailLink}`} style={{ textDecoration: "none", color: "#00FF41", fontSize: "1.5rem" }}><i className="fa-regular fa-envelope"></i>   khanfaizan1123@gmail.com</a>
            </Box>
        </Box>
    )
}

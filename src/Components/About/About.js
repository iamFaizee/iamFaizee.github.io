...
import resume from '../../media/Faizan-Resume.pdf';
...
const About = () => {
    ...
    const openResume = () => {
        window.open(
            "https://drive.google.com/file/d/16eETNgN7s-iydOws29-n2cgqdqlFD5in/view?usp=sharing",
            "_blank"
        );
    };
        ...
        <Grid container id="about" className='about section' sx={{ width: "80%", margin: "10% auto", padding: "0% 10px" }} spacing={2}>
            <Grid item xs={12} sm={6} md={6} sx={{ margin: "auto" }}>
                <Box sx={{ borderTop: "2px solid rgb(35, 53, 84)", position: "relative" }}>
                    <Typography className='aboutHeading' variant='h4' sx={{ color: "#00FF41", backgroundColor: "rgb(11, 24, 47)", position: "absolute", top: "-25px", padding: "0% 5% 0% 0%", fontFamily: "Poppins" }}>About Me</Typography>
                    <Typography id="user-detail-intro" className='aboutText' sx={{ marginTop: "8%", color: "#008F11", fontFamily: "Poppins" }}>
                        Hello! My name is <span style={{ color: "#00FF41" }}>Faizan</span> and I enjoy creating things that live on the internet. My interest in computers and technology started back when I was in my 6th grade and my father brought me a computer, and since then, I've been exploring various aspects of it.
                        <br /><br />
                    ...
                    <Box id="resumeBtn" onClick={openResume} marginTop='1.5rem' sx={{ display: "flex", justifyContent: "center" }}>
                        <Button variant="outlined" href={resume} download="Faizan-Resume" id="resume-button-2" sx={{ border: "1px solid #008F11", color: "#00FF41", fontSize: "0.8rem", fontFamily: "Poppins", margin: "auto" }}>Resume</Button>
                        <LinearDeterminate color={"transparent"} />
                    </Box>
                </Box>
            </Grid>
